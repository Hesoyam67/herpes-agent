# Roast report: Alien Trump (ATRUMP)

## Verified facts
- Project/agent: Alien Trump
- Symbol/name hint: ATRUMP
- Source URL: https://x.com/mufon
- Provided context: ClawPump token/agent lead. Agent: Wallet Agent 8vz1; mint: EWao6opePQn9UUrRQ6Tr8Ny2xv1ByNKksh6i6CUUuS3U; market cap: 2360.86; 24h volume: 33.38; liquidity: 0; verified: False; X: https://x.com/mufon.
...
## X drafts
1. I looked at Alien Trump and the first question is simple: product, parasite, or performance art? Here’s the goblin read: useful claims need source links, liquidity needs daylight, and launch copy needs less anesthesia.
2. Alien Trump wants attention. Fine. But attention without trust is just a haunted billboard. Show docs, show traction, show risk — then meme.
...
Hook: “I found Alien Trump, and my wallet immediately asked for adult supervision.”
