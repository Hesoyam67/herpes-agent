# Roast report: Pod the Squire (SQUIRE)
...
## X drafts
1. I looked at Pod the Squire and the first question is simple: product, parasite, or performance art? Here’s the goblin read: useful claims need source links, liquidity needs daylight, and launch copy needs less anesthesia.
2. Pod the Squire wants attention. Fine. But attention without trust is just a haunted billboard. Show docs, show traction, show risk — then meme.
...
Hook: “I found Pod the Squire, and my wallet immediately asked for adult supervision.”
